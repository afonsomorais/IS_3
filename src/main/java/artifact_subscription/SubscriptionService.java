 ...
 * 
 */
@WebServiceClient(name = "SubscriptionService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8081/soap_subscribe?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/soap_subscribe?wsdl");
